...
public class PositionTest implements ApplicationListener {
    ...
    public Vector3 mCamPosition = Vector3.Zero;
    public Vector3 camDirection = Vector3.Z.scl(-1);
    public Vector3 camUp = Vector3.Y;
    ...
    public boolean useManualControl() {
        return mUseManualControl;
    }

    public void setUseManualControl(boolean value) {
        this.mUseManualControl = value;
        Gdx.input.setInputProcessor(value ? camControl : null);
    }

    @Override
    public void render() {
        if (!mUseManualControl) {
            camera.position.set(mCamPosition);
